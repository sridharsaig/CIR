...
In detail, to install the above libraries direct into - [INSTALL.md] (Modified_Camera_Positioner/INSTALL). In addition, libraries towards development of the project / altering the source codes can be installed under the same md. 
